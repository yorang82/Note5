...
public class lap5_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lap5_2);
    ...
    DialogInterface.OnClickListener dialogListener=new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            if(dialog==customDialog && which==DialogInterface.BUTTON_POSITIVE){
                ...
                showToast("aler dialog ok click....");
            }
        }
    };
    ...
    public void onClick(View v) {
        if(v==alertBtn){
            ...
            builder.setPositiveButton("KO", dialogListener);
